...
function BackToTopButton() {
  return (
    <button
      ...
      className="hidden md:flex w-44 h-12 bg-transparent border border-neutral-400 text-white text-base group items-center justify-center gap-2 relative overflow-hidden"
    >
...
export default function Footer() {
  return (
    <footer className="z-10 bg-transparent pb-6 md:pb-4 px-4 md:px-8 w-screen">
            ...
            <div className="relative items-center h-5 overflow-hidden uppercase">
              <div className="transition-transform duration-500 ease-out group-hover:-translate-y-6">
                <span className="tracking-tight block leading-[22px] text-neutral-400 md:text-white text-center transform origin-right group-hover:rotate-[15deg]">
                  &copy; {new Date().getFullYear()} Bachtiar Dwi Pramudi
                </span>
